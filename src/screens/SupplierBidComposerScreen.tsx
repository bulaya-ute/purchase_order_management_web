...
/**
 * Dedicated bid-creation flow: pick a supplier (creates a fresh bid immediately), then add line
 * items sourced from that supplier's quotations via a per-quotation line-picker modal. The right
 * column shows the bid's live items with inline quantity editing and removal. If a purchaseOrderId
 * query param is present the bid is created already attached to that PO, and "Done" returns to
 * the PO composer; otherwise the bid is standalone and "Done" returns to the bids library.
 */
  ...
  return (
    <section className="admin-screen admin-screen--wide">
      <div className="admin-header">
        ...
        <Link
          to={purchaseOrderId ? `/purchase-orders/${purchaseOrderId}/edit` : '/supplier-bids'}
